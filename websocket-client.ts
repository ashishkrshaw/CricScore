...
export const recordBall = (payload: { runs: number; extra?: ExtraType; wicketType?: WicketType; batsmanOutId?: number }) => sendMessage('recordBall', payload);
export const undoLastBall = () => sendMessage('undoLastBall');
export const addPlayer = (payload: { team: 'teamA' | 'teamB'; playerName: string; nickname?: string }) => sendMessage('addPlayer', payload);
